                ...
                return (
                  <div key={transaction.id} className="p-5 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-semibold text-gray-600">Điểm sau GD (Người gửi):</span>
                        <span className="text-base font-sans font-medium text-gray-800">
                          {transaction.diem_sau_giao_dich_nguoi_gui !== null && transaction.diem_sau_giao_dich_nguoi_gui !== undefined
                            ? parseFloat(transaction.diem_sau_giao_dich_nguoi_gui).toFixed(2)
                            : '-'}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-semibold text-gray-600">Điểm sau GD (Người nhận):</span>
                        <span className="text-base font-sans font-medium text-gray-800">
                          {transaction.diem_sau_giao_dich_nguoi_nhan !== null && transaction.diem_sau_giao_dich_nguoi_nhan !== undefined
                            ? parseFloat(transaction.diem_sau_giao_dich_nguoi_nhan).toFixed(2)
                            : '-'}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                    ...
                    <div className="pt-3 border-t border-gray-200 flex gap-2 flex-wrap">
                      {/* Nút Chốt - chỉ hiển thị khi chưa chốt, là Giao lịch và chưa bị hủy */}
                      {isChuaChot && isGiaoLich && !isCancelled && (
                        <button
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">
                      Điểm sau GD (Người gửi)
                    </th>
                    <th className="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">
                      Điểm sau GD (Người nhận)
                    </th>
                    <th className="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">
                      Nội dung
                    </th>
