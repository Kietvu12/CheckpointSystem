...
CREATE TABLE `bao_cao` (
  ...
  `ten_bao_cao` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên báo cáo (ví dụ: Báo cáo ngày 2024-01-15)',
  `ngay_bao_cao` date NOT NULL COMMENT 'Ngày của báo cáo',
  `duong_dan_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Đường dẫn file Excel đã xuất (nếu có)',
  `loai_bao_cao` enum('tu_dong','thu_cong') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'thu_cong' COMMENT 'Loại báo cáo: tự động (23h59) hoặc thủ công',
...
CREATE TABLE `giao_dich` (
  ...
  `diem_sau_giao_dich_nguoi_gui` decimal(10,2) DEFAULT NULL COMMENT 'Số điểm của người gửi sau giao dịch',
  `diem_sau_giao_dich_nguoi_nhan` decimal(10,2) DEFAULT NULL COMMENT 'Số điểm của người nhận sau giao dịch',
  `id_giao_dich_doi_chung` int DEFAULT NULL COMMENT 'ID của giao dịch đối chứng (nếu có)',
  `noi_dung_giao_dich` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Nội dung giao dịch (có thể NULL)',
  `trang_thai` enum('chua_chot','da_chot') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'chua_chot' COMMENT 'Trạng thái giao dịch: chua_chot (chưa chốt), da_chot (đã chốt)',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `loai_giao_dich` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten_loai_giao_dich` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '3 loại: San điểm, Giao lịch, Hủy lịch',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `nguoi_dung` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten_zalo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `mat_khau` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Mật khẩu đã được hash',
  `thong_tin_xe` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Thông tin xe',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2859 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-13 10:32:44
